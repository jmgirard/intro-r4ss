...
We will begin with an overview of the workshop, an introduction to R and RStudio, and the basics of programming. The latter will cover basic math operations, creating and naming objects, and calling functions.
...
"The Literal Genie" - What it feels like to talk to R sometimes
